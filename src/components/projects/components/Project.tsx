...
const Project: FC<ProjectProps> = ({ index, title, subtitle, manageModal, tech, slug }) => {
  ...
  return (
    <Link
      ...
      className="flex w-full flex-col gap-3 lg:flex-row lg:justify-between justify-start lg:items-center items-start py-4 border-t-2 border-t-gray-300 cursor-pointer transition-all text-stone-950 dark:text-stone-50"
    >
      <div>
      ...
      <div>
        <p className="text-xs tracking-wide lg:text-right pb-2 font-medium">Tech Stack</p>
