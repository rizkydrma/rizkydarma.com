...
banner: '/projects/medical-vaccine/diyxlhdz52pj8jjnkg5a'
...
<SplitImage>
  <Split>
    <CloudinaryImg
      mdx
      className="!mb-0"
      publicId="projects/medical-vaccine/diyxlhdz52pj8jjnkg5a"
      alt="landing-page"
      width={800}
      height={426}
    />
  ...
  <Split>
    <CloudinaryImg
      mdx
      className="!mb-0"
      publicId="projects/medical-vaccine/dyf9ps4hembkjkofsuxt"
      alt="landing-page"
      width={800}
      height={426}
    />
  ...
  <Split>
    <CloudinaryImg
      mdx
      className="!mb-0"
      publicId="projects/medical-vaccine/kgfr5ddkyjctt48u1dxy"
      alt="landing-page"
      width={800}
      height={426}
    />
  ...
  <Split>
    <CloudinaryImg
      mdx
      className="!mb-0"
      publicId="projects/medical-vaccine/fuc7ys7o5tqh7sqdrbt0"
      alt="landing-page"
      width={800}
      height={426}
    />
  ...
  <Split>
    <CloudinaryImg
      mdx
      className="!mb-0"
      publicId="projects/medical-vaccine/oahfrczp2x8lg5mv82g6"
      alt="landing-page"
      width={800}
      height={426}
    />
  ...
  <Split>
    <CloudinaryImg
      mdx
      className="!mb-0"
      publicId="projects/medical-vaccine/wd5nf4ov1ghhstbuqrtq"
      alt="landing-page"
      width={800}
      height={426}
    />
